...
#define	EVENT_H
     ...
     * Prototypes
     */
    int event_timeout(long usecs,
            int (*callback)(void*), void *callback_arg, char *idstr);
    ...
    int event_timeout_delete(int (*callback)(void*), void *callback_arg);
    int event_fd_delete(int (*callback)(int, void*), void *callback_arg);
    int event_fd(int fd, int (*callback)(int, void*), void *callback_arg, char *idstr);
    int eventloop(void);
